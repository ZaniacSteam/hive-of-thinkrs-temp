...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: "What is Hive of Thinkrs?",
        a: "Hive of Thinkrs is a creative learning lab where students from Kindergarten through 12th grade explore science, coding, math, and design through game-based, hands-on learning. Our programs help kids build real-world skills, confidence, and curiosity that last a lifetime. We also do Test Preparation for standardized, private school and college admissions tests such as SAT, ACT, SSAT and ISEE."
      },
      {
        q: "How is Hive of Thinkrs different from other tutoring or STEAM programs?",
        a: "We're not worksheets and lectures. We're invention, play, and problem-solving. Every lesson blends fun and learning — whether students are programming a robot, crafting a digital game, or leveling up in algebra."
      },
      {
        q: "Do you offer online or in-person classes?",
        a: "Both. We offer flexible options to meet your family's needs — in-person at home or at one of our partner locations, or fully online with interactive tools like stylus tablets and digital dashboards."
      },
      {
        q: "What ages or grades do you serve?",
        a: "We support students from Kindergarten to 12th grade across all academic levels — from early reading to college admissions."
      },
      {
        q: "What kinds of programs do you offer?",
        a: "Our core offerings include: STEAM Enrichment (Coding, Robotics, 3D Design, Game Development), Academic Tutoring (Math, Reading, Writing, Science), Test Prep (ISEE, SSAT, SAT, ACT), Study Smart (Executive Functioning & Time Management)"
      },
      {
        q: "Where are your STEM programs located?",
        a: "We offer programs throughout South Florida's tri-county area, including Miami-Dade, Broward, and Palm Beach counties"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      {
        q: "How does your Test Prep work?",
        a: "We start with a diagnostic and build a personalized plan based on each student's goals. Our approach includes subject-specific tutoring, homework, vocabulary training, and proctored practice tests. Students typically improve their SAT score by 200+ points and ACT by 7–10 points."
      },
      {
        q: "Do you provide practice tests?",
        a: "Yes. We run monthly proctored SAT, ACT, ISEE, and SSAT practice exams to simulate real test conditions and adjust learning plans accordingly."
      },
      {
        q: "Who are your instructors?",
        a: "Our team includes experienced, background-checked professionals with STEM or education degrees. Many also teach advanced learners during the school year at top schools in Miami."
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "What types of after-school programs can we bring to our school?",
        a: "We offer custom STEAM and academic programs for K–12. From robotics and coding to creative design and executive functioning, our after-school options are hands-on, turnkey, and beloved by students."
      },
      {
        q: "Do you provide instructors and materials?",
        a: "Yes. We handle the full experience — instructors, curriculum, tech materials, and student engagement. Think of us as your enrichment partner, not just a vendor."
      },
      {
        q: "What's the first step to bring Hive of Thinkrs to our school?",
        a: "Reach out to us at yourhive@beathinkr.com or call 305-668-0605. We'll start with a discovery consultation to understand your needs and design a custom plan for your community."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: "Click here and fill out the form. We'll set up a brief call to match you with the right program and instructor."
      },
      {
